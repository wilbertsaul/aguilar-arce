        ...
        <div class="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div class="lg:col-span-5 space-y-12">
                ...
                <div class="space-y-8 pt-8 border-t border-outline-variant/30">
                    <div class="flex gap-6 items-start">
                        ...
                        <div>
                            <h4 class="text-navy uppercase tracking-wider mb-2" style="font-size:10px; font-weight:600; letter-spacing:0.1em;">Ubicación Estratégica</h4>
                    ...
                    <div class="flex gap-6 items-start">
                        ...
                        <div>
                            <h4 class="text-navy uppercase tracking-wider mb-2" style="font-size:10px; font-weight:600; letter-spacing:0.1em;">Horario de Atención</h4>
                    ...
                    <div class="flex gap-6 items-start">
                        ...
                        <div>
                            <h4 class="text-navy uppercase tracking-wider mb-2" style="font-size:10px; font-weight:600; letter-spacing:0.1em;">Contacto Directo</h4>
            ...
            <div class="lg:col-span-7">
                <div class="relative">
                    ...
                    <div class="bg-surface-container-low p-8 md:p-12 rounded-[32px] shadow-2xl shadow-navy/5 border border-white/50 backdrop-blur-sm">
                        ...
                        <form action="{{ route('consultoria.store') }}" method="POST" class="space-y-6" id="consultoria-form">
                            ...
                            <div class="space-y-2">
                                <label for="email" class="block text-navy uppercase tracking-widest" style="font-size:10px; font-weight:600; letter-spacing:0.1em;">CORREO ELECTRÓNICO</label>
                                <input
                                    type="email"
                                    id="email"
                                    name="email"
                            ...
                            <div class="space-y-2">
                                <label for="mensaje" class="block text-navy uppercase tracking-widest" style="font-size:10px; font-weight:600; letter-spacing:0.1em;">MENSAJE</label>
                                <textarea
                                    id="mensaje"
                                    name="mensaje"
                                    required
                    ...
                    {{-- Office image --}}
                    <div class="mt-8 overflow-hidden rounded-2xl border border-outline-variant/20 shadow-lg lg:absolute lg:-bottom-24 lg:-left-24 lg:w-72 lg:mt-0 hidden sm:block">
