<nav class="fixed top-0 w-full z-50 glass-nav transition-all duration-300" id="navbar">
    <div class="max-w-container-max mx-auto px-gutter flex items-center justify-between h-20 md:h-24">
        ...
        <div class="hidden md:flex items-center gap-8">
            ...
            <a href="#nosotros" class="text-sm font-medium text-navy/70 hover:text-navy transition-colors">Nosotros</a>
            <a href="#transformacion-digital" class="text-sm font-medium text-navy/70 hover:text-navy transition-colors">Transformación Digital</a>
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-grey-light/50 px-gutter py-6">
        <div class="flex flex-col gap-4">
            <a href="#servicios" class="text-navy font-medium py-2" onclick="toggleMenu()">Servicios</a>
