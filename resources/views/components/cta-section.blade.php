<section class="relative py-32 tech-gradient overflow-hidden" id="contacto">
    ...
    <div class="relative z-10 max-w-container-max mx-auto px-gutter text-center">
        <h2 class="text-headline-lg md:text-5xl text-white font-bold mb-6 reveal-on-scroll">
