        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-12">
            ...
            <div class="md:col-span-4">
                ...
                <div class="flex gap-4 mb-6">
                    ...
                    <a class="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors" href="https://wa.me/51940414383?text=Hola,%20me%20gustar%C3%ADa%20recibir%20m%C3%A1s%20informaci%C3%B3n%20sobre%20sus%20servicios%20de%20consultor%C3%ADa.%20%C2%BFPodr%C3%ADan%20contactarme%3F" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
                ...
                <p class="text-white/40 text-sm">aguilaryarceconsultores@gmail.com</p>
            </div>
        </div>
    </div>
